<x-app-layout>
    ...
    <div class="flex bg-primary overflow-hidden shadow-sm justify-start">
        <div class="py-10 pl-14">
            <img src="{{ asset('images/logo-angels-product.png') }}" alt="Dashboard Image" class="w-40">
        </div>
        <div class="py-10 px-6 text-white">
            <h1 class="text-3xl font-bold">PT. ANGELS PRODUCT</h1>
            {{-- alamat --}}
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-6 text-white">
        ...
        <div class="bg-[#FD7E14] p-6 rounded-lg shadow-md">
            ...
            <p class="mt-2">Jumlah: 2</p>
            <a href="{{ route('surat-keluar') }}" class="mt-4 inline-block hover:underline">Lihat
                Detail</a>
        </div>
