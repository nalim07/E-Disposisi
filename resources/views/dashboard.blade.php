    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-6 text-white">
        ...
        @role('admin')
            <div class="bg-[#FD7E14] p-6 rounded-lg shadow-md">
                ...
                <p class="mt-2">Jumlah: Jumlah: {{ $outgoingMailCount }}</p>
            ...
            <div class="bg-[#28A745] p-6 rounded-lg shadow-md">
                ...
                <p class="mt-2">Jumlah: Jumlah: {{ $archiveCount }}</p>
        ...
        @role('pimpinan')
            <div class="bg-[#17A2B8] p-6 rounded-lg shadow-md">
                <div class="flex items-center gap-4">
                    <!-- Ikon disposisi (bisa pakai ikon lain juga) -->
                    <svg xmlns="http://www.w3.org/2000/svg" width="49" height="55" viewBox="0 0 24 24"
                        fill="none">
                        <path d="M12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2ZM17 13H13V17H11V13H7V11H11V7H13V11H17V13Z" fill="#F5F5F5" />
                    </svg>
                    <h2 class="text-xl font-semibold">Disposisi</h2>
                </div>
                {{-- <p class="mt-2">Jumlah: {{ $dispositionCount }}</p> --}}
                <a href="{{ route('disposisi') }}" class="mt-4 inline-block hover:underline">Lihat Detail</a>
            </div>
        @endrole
    </div>
    {{-- End Card --}}
