<x-app-layout>
    <x-slot name="title">Detail Surat - {{ $incomingMail->mail_number }}</x-slot>
    ...
    <div class="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md">
        ...
        <div class="space-y-4">
            ...
            <div class="grid grid-cols-12 gap-4">
                ...
                <div class="col-span-10">: {{ $incomingMail->mail_number }}</div>

                <div class="col-span-2 font-medium">Pengirim</div>
                <div class="col-span-10">: {{ $incomingMail->sender }}</div>

                <div class="col-span-2 font-medium">Perihal</div>
                <div class="col-span-10">: {{ $incomingMail->subject }}</div>

                <div class="col-span-2 font-medium">Tanggal Surat</div>
                <div class="col-span-10">: {{ $incomingMail->mail_date }}</div>

                <div class="col-span-2 font-medium">Tanggal Terima</div>
                <div class="col-span-10">: {{ $incomingMail->received_date }}</div>

                <div class="col-span-2 font-medium">File</div>
                <div class="col-span-10">
                    : <a href="{{ asset('storage/' . $incomingMail->file_path) }}" class="text-blue-600 hover:underline"
                        target="_blank">
                ...
                <div class="col-span-10">
                    : <span class="px-2 py-1 rounded-full {{ $incomingMail->status_badge }}">
                        {{ $incomingMail->status }}
                    </span>
                </div>
            </div>
            ...
            <div class="flex gap-4 mt-10">
                <!-- Tombol Edit -->
                <a href="{{ route('surat-masuk.edit', $incomingMail) }}"
                        ...
                        <div class="mt-3 text-center">
                            ...
                            <div class="items-center px-4 py-3">
                                <form id="deleteForm" method="POST"
                                    action="{{ route('surat-masuk.destroy', $incomingMail) }}">
                                    @csrf
                                    @method('DELETE')
