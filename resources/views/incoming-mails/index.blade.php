                            ...
                            <tr>
                                ...
                                <x-table-cell>
                                    <div class="grid grid-cols-2 gap-2">
                                        ...
                                        {{-- kirim --}}
                                        <x-action-button href="{{ route('disposisi', $incomingMail->id) }}"
                                            icon="M3 20.9429V4.94286L22 12.9429L3 20.9429ZM5 17.9429L16.85 12.9429L5 7.94286V11.4429L11 12.9429L5 14.4429V17.9429ZM5 17.9429V12.9429V7.94286V11.4429V14.4429V17.9429Z"
                                            label="Kirim" color="green" />
